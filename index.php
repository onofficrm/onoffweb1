...
if (function_exists('g5site_cfg')) {
    $onoffweb1_home_builder_id = g5site_cfg('home_builder_bridge_id', '');
    if ($onoffweb1_home_builder_id !== '') {
        $onoffweb1_home_builder_id = preg_replace('/[^a-z0-9_-]/i', '', $onoffweb1_home_builder_id);
        if ($onoffweb1_home_builder_id !== '') {
            if (!defined('ONOFF_BUILDER_LOADED') && defined('G5_PLUGIN_PATH')) {
                $onoffweb1_builder_bootstrap = G5_PLUGIN_PATH . '/onoff-builder-bridge/bootstrap.php';
                if (is_file($onoffweb1_builder_bootstrap)) {
                    include_once $onoffweb1_builder_bootstrap;
                }
            }
            if (function_exists('onoff_builder_render_import_page')) {
                onoff_builder_render_import_page($onoffweb1_home_builder_id);
                exit;
            }
        }
    }
